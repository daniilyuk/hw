...
import ru.antonov.jdbc.ex05_repositories.for_remove.UsersDao;
import ru.antonov.jdbc.ex05_repositories.for_remove.UsersDaoImpl;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        try {
            dataSource = new DataSource("jdbc:postgresql://localhost:5432/hw7_database?user=postgres&password=post21");
            dataSource.connect();
